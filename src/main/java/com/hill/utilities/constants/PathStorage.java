...
public final class PathStorage {
    ...
    public static final Path DOWNLOADS_PATH = Paths.get(PropertyReader.getProperty("download.path")).toAbsolutePath();
    ...
    public static final String REPORT_ARCHIVE_DIR = PropertyReader.getProperty("archive.location")
            .replace("\\", "/");
