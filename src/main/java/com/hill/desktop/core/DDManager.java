...
import com.hill.desktop.utilities.RunHelperDesktop;
...
//    private static final Logger log = LoggerFactory.getLogger(DDManager.class);
    ...
    public static void tearDown() {
        driver.quit();
        CommandRunner.runComm(Commands.PowerShell.WIN_DRIVER_STOP);
    }
    ...
    private static void statusCheck() {
        ...
        if (!RunHelperDesktop.isWinDriverOk()) {
            CommandRunner.runComm(Commands.PowerShell.WIN_DRIVER_START);
